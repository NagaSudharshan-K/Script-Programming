 ...
 * Generated at: 2023-11-30 11:09:54 UTC
...
st.executeUpdate("insert into customer(CustomerId,Name,Address,City,State,Zip,Phone,Email)values('"+id+"','"+name+"','"+address+"','"+city+"','"+state+"','"+zipCode+"','"+phone+"','"+email+"')");
//out.println("Data is successfully inserted!");
}
catch(Exception e)
{
